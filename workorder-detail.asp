...
response.write ("<FORM name='wo-detail' id='wo-detail'>")
%>
...
response.write "<div align='right'><input type='button' name='cancel' id='cancel' value='Cancel' onclick='onCancel();'> &nbsp; &nbsp; <input type='button' name='update' id='update' value='Update'></div>"
response.write "</form>"
